...
/*
	...
	$fileInsert = "insert.sql";
	$currentInsert = file_get_contents($fileInsert);
	$currentInsert .= $insert . "\n";
	file_put_contents($fileInsert, $currentInsert);

	$fileUpdateExist = "update_exist.sql";
	$currentUpdateExist = file_get_contents($fileUpdateExist);
	$currentUpdateExist .= $update . "\n";
	file_put_contents($fileUpdateExist, $currentUpdateExist);

	$fileUpdateNotExist = "update_not_exist.sql";
	$currentUpdateNotExist = file_get_contents($fileUpdateNotExist);
	$currentUpdateNotExist .= $updateNotExists . "\n";
	file_put_contents($fileUpdateNotExist, $currentUpdateNotExist);
